# Testing Guide for NetBox SopCompliance Plugin

This guide explains how to write and run tests for NetBox SopCompliance Plugin.

## Test Structure

Tests are organized in the `sop_compliance/tests/` directory:
...
```python
from sop_compliance.testing import PluginTestCase
...
```python
from sop_compliance.testing import PluginModelTestCase
...
```python
from sop_compliance.testing import PluginAPITestCase

class MyAPITestCase(PluginAPITestCase):
    def setUp(self):
        super().setUp()
        self.list_url_name = 'plugins-api:sop_compliance-api:mymodel-list'
        self.detail_url_name = 'plugins-api:sop_compliance-api:mymodel-detail'
...
```python
from sop_compliance.testing import PluginViewTestCase

class MyViewTestCase(PluginViewTestCase):
    def setUp(self):
        super().setUp()
        self.base_url = 'plugins:sop_compliance:mymodel'
...
```python
from sop_compliance.testing import PluginGraphQLTestCase
...
The `sop_compliance.testing.utils` module provides helpful utilities:

```python
from sop_compliance.testing.utils import (
...
user = create_test_user(permissions=['sop_compliance.view_sopcompliance'])
...
python manage.py test sop_compliance.tests

# Run specific test file
python manage.py test sop_compliance.tests.test_models

# Run specific test class
python manage.py test sop_compliance.tests.test_models.SopcomplianceTestCase

# Run specific test method
python manage.py test sop_compliance.tests.test_models.SopcomplianceTestCase.test_create

# Run with verbose output
python manage.py test sop_compliance.tests -v 2

# Run in parallel (faster)
python manage.py test sop_compliance.tests --parallel

# Keep database between runs (faster during development)
python manage.py test sop_compliance.tests --keepdb
```
...
# Run tests
docker-compose exec netbox python manage.py test sop_compliance.tests

# Run specific tests
docker-compose exec netbox python manage.py test sop_compliance.tests.test_api
...
def test_form_validation(self):
    ...
    url = reverse('sop_compliance:mymodel_add')
...
**"No module named 'sop_compliance'"**
