"""
Search indexes for NetBox SopCompliance Plugin.
...
class SopcomplianceIndex(SearchIndex):
    """
    Search index for Sopcompliance model.

    This enables Sopcompliance objects to appear in NetBox's global
    search results.
    """
    ...
    # category = 'NetBox SopCompliance Plugin'
