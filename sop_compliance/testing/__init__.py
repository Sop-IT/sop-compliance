"""
Standalone testing base classes for NetBox SopCompliance Plugin.
    ...
    def add_permissions(self, *permissions: str):
        ...
        Args:
            *permissions: Permission names in format "app.action_model"
                         e.g., "sop_compliance.add_sopcompliance"
...
class PluginViewTestCase(PluginModelTestCase):
    ...
    def _get_base_url(self) -> str:
        ...
        Returns:
            Base URL string (e.g., "plugins:sop_compliance:sopcompliance")
        """
