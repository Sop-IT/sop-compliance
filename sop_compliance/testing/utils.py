"""
Utility functions for testing NetBox SopCompliance Plugin.
...
def create_test_user(username: str | None = None, permissions: list[str | None] = None,
    ...
    Example:
        ...
        ...     permissions=['sop_compliance.view_sopcompliance']
        ... )
    """
    if username is None:
...
def post_data(data: dict[str, Any]) -> dict[str, Any]:
    ...
    Example:
        ...
        >>> obj = Sopcompliance.objects.first()
...
def get_deletable_objects(instances):
    ...
    Example:
        >>> objs = Sopcompliance.objects.filter(name__startswith='test')
        >>> deletions = get_deletable_objects(objs)
        >>> # deletions = {'Sopcompliance': 3, 'RelatedModel': 5}
    """
...
def assert_object_changes(test_case, instance, action: str,
    ...
    Example:
        ...
        >>> obj = Sopcompliance.objects.create(name='Test')
