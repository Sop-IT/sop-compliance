...
### Release Summary
Initial release of NetBox SopCompliance Plugin. This is a **minor** release introducing basic functionality for managing SopCompliance resources in NetBox.

### Added
- Initial plugin structure with Sopcompliance model
